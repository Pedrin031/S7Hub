wait(0.1) 
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("S7 Hub",Enum.KeyCode.RightControl)
      
      local Main = sxhub:AddTab("Main","6026568198")
Main:AddLabel("Created By Pedrin031")
Main:AddButton("💬 Discord - S7 Hub", function()
    setclipboard("https://discord.gg/jfKVrrMx")
    ui:Notification("S7 Hub", "Link do Discord copiado para a área de transferência!", 3)
end)
